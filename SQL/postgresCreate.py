...
mydb = psycopg2.connect(
  ...
  host="databases.sis.ai",
  user="postgres",
  password="Synergies123",
  database="postgres"
...
mycursor.execute("CREATE TABLE Doris_test02 ( id int,c_char VARCHAR(255), c_char1 VARCHAR(255),n_int int,b_boolean boolean,t_time Date)")
